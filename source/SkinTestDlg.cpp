...
void CSkinTestDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSkinTestDlg)
...
BEGIN_MESSAGE_MAP(CSkinTestDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_NEOSYTLE, OnNeosytle)
	ON_BN_CLICKED(IDC_XPSTYLE, OnXpstyle)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CSkinTestDlg message handlers

BOOL CSkinTestDlg::OnInitDialog()
{
...
void CSkinTestDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CSkinTestDlg::OnQueryDragIcon()
{
